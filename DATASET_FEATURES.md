...
| 網路類型 | 節點 | 邊 | 資料表 |
|----------|------|-----|--------|
| 使用者上線模式 | 月份 | 活動關係 | Posts.creation_date, Users.last_access_date |
| 問題熱度傳播 | 問題 | 時間關係 | Posts.creation_date, Posts.last_activity_date |
| 技術趨勢演變 | 標籤 | 時間關係 | Posts.tags, Posts.creation_date |

### 5. 地理網路 (Geographic Networks)
| 網路類型 | 節點 | 邊 | 資料表 |
|----------|------|-----|--------|
| 使用者地理分布 | 國家/城市 | 連接 | Users.location |

---

## 推薦的擴展分析主題

基於完整資料集，建議新增以下分析（涵蓋 15 個社會網路分析主題）：

1. **使用者聲望與網路中心度分析**: 分析高聲望使用者是否處於網路核心位置
2. **網路核心結構與解答效率分析**: 分析核心位置發問者的問題解決速度
3. **技術標籤共現與領域地圖分析**: 建構技術發展地圖
4. **知識孤島與連通分量分析**: 檢測社群中的邊緣化現象
5. **內容特徵與互動反響分析**: 分析程式碼區塊對社群回饋的影響
6. **帳號年資與社群貢獻分析**: 分析老手與新手行為差異
7. **投票行為網路分析**: 分析投票行為與使用者影響力的關係
8. **評論互動網路分析**: 構建評論者之間的社交網路
9. **徽章成就網路分析**: 分析徽章獲得者的網路結構
10. **編輯協作網路分析**: 識別多人共同編輯的協作關係
11. **引用與重複問題網路分析**: 分析問題之間的知識傳播路徑
12. **審核任務網路分析**: 識別積極參與社群審核的使用者
13. **賞金懸賞網路分析**: 分析懸賞問答的知識流動
14. **使用者地理分布網路分析**: 建構使用者地理位置網路
15. **時間序列活躍度網路分析**: 分析使用者上線模式的時間規律
